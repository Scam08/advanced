    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
               <b></b> <p><?=Yii::$app->user->identity->username ?></p> </b>
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    '<li class="header">Меню Yii2</li>',
                    ['label' => '<span class="fa fa-file-code-o"></span> Пользователи', 'url' => ['/user']],
                    ['label' => '<span class="fa fa-file-code-o"></span> Объявления', 'url' => ['/advert']],
